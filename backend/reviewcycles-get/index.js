...
module.exports = async function (context, req) {
  try {
    ...
    // ----------------------------------------
    if (appId) {
      let query = "SELECT c.id, c.cycleId, c.name, c.appId, c.appName, c.appIds, c.appTypes, c.scope, c.scopeSummary, c.status, c.stagedAt, c.launchedAt, c.startAt, c.startNow, c.dueDate, c.completedAt, c.cancelledAt, c.cancelReason, c.totalItems, c.pendingItems, c.pendingRemediationItems, c.confirmedManagers, c.campaignOwnerId, c.campaignOwnerName, c.reviewerType, c.reviewerLabel, c.specificReviewerId, c.orphanReviewerMode, c.orphanReviewerId, c._etag, c._ts FROM c WHERE c.appId=@a";
    ...
    // -----------------------------------------------------
    let queryAll =
      "SELECT c.id, c.cycleId, c.name, c.appId, c.appName, c.appIds, c.appTypes, c.scope, c.scopeSummary, c.status, c.stagedAt, c.launchedAt, c.startAt, c.startNow, c.dueDate, c.completedAt, c.cancelledAt, c.cancelReason, c.totalItems, c.pendingItems, c.pendingRemediationItems, c.confirmedManagers, c.campaignOwnerId, c.campaignOwnerName, c.reviewerType, c.reviewerLabel, c.specificReviewerId, c.orphanReviewerMode, c.orphanReviewerId, c._etag, c._ts FROM c WHERE c.type = 'review-cycle'"; // make sure your cycle docs have type set
    const paramsAll = [];
