  ...
  try {
    ...
    if (accountId) {
      const { resources } = await c.items.query({
        query: "SELECT TOP 1 c.id, c.appId, c.userId, c.userName, c.email, c.entitlement, c.accountStatus, c.customAttributes, c.correlation, c.sod, c.isOrphan, c.isPrivileged, c.updatedAt, c.createdAt, c._etag, c._ts FROM c WHERE c.appId=@a AND c.id=@id",
    ...
    let query = "SELECT c.id, c.appId, c.userId, c.userName, c.email, c.entitlement, c.accountStatus, c.customAttributes, c.correlation, c.sod, c.isOrphan, c.isPrivileged, c.updatedAt, c.createdAt, c._etag, c._ts FROM c WHERE c.appId=@a";
